...
def get_license_result(ocr,image):
    ...
    if result:
        ...
        return None, None
# 需要检测的图片地址
img_path = "TestFiles/01748802682-90_90-326&368_560&459-574&450_323&455_324&369_575&364-0_0_15_33_33_31_28-102-27.jpg"
...
cv2.imshow("YOLOv11 Detection", now_img)
cv2.waitKey(0)